...
custom_options  +=		'<span class="icon-flower134 animate-spin"></span>';
custom_options  +=	'</a>';
...
custom_options  +=								'<a href="#" class="co_reset_to_default icon-arrows-ccw" title="Reset to default"> </a>';
custom_options  +=							'</div>';
...
custom_options  +=											'<input type="hidden" name="co_theme_color" value="#fe90ad"/>';
custom_options  +=											'<div id="co_theme_color" class="iColorPicker"> </div>';
custom_options  +=											'<input type="hidden" name="co_theme_color_1" value="#84dce6"/>';
custom_options  +=											'<div id="co_theme_color_1" class="iColorPicker"> </div>';
custom_options  +=											'<input type="hidden" name="co_theme_color_2" value="#293364"/>';
custom_options  +=											'<div id="co_theme_color_2" class="iColorPicker"> </div>';
custom_options  +=											'<input type="hidden" name="co_theme_color_3" value="#fbc85b"/>';
custom_options  +=											'<div id="co_theme_color_3" class="iColorPicker"> </div>';
custom_options  +=										'</div>';
custom_options  +=									'</div>';
custom_options  +=									'<div class="co_form_row">';
custom_options  +=										'<input type="hidden" name="co_bg_pattern" value=""/>';
custom_options  +=										'<span class="co_label">Theme pattern:</span>';
...
custom_options  +=											'</a>';
custom_options  +=											'<a href="#" id="pattern_3" class="no_margin co_pattern_wrapper">';
custom_options  +=												'<img src="custom_tools/images/bg/pattern_3_thumb2.png" alt=""/>';
custom_options  +=											'</a>';
custom_options  +=										'</div>';
custom_options  +=									'</div>';
custom_options  +=									'<div class="co_form_row">';
custom_options  +=										'<input type="hidden" name="co_bg_image" value=""/>';
custom_options  +=										'<span class="co_label">Backgroud images:</span>';
custom_options  +=										'<div id="co_bg_images_list">';
custom_options  +=											'<a href="#" id="image_1" class="co_image_wrapper">';
custom_options  +=												'<img src="custom_tools/images/bg/image_1_thumb2.jpg" alt=""/>';
custom_options  +=											'</a>';
custom_options  +=											'<a href="#" id="image_2" class="co_image_wrapper">';
custom_options  +=												'<img src="custom_tools/images/bg/image_2_thumb2.jpg" alt=""/>';
custom_options  +=											'</a>';
custom_options  +=											'<a href="#" id="image_3" class="no_margin co_image_wrapper">';
custom_options  +=												'<img src="custom_tools/images/bg/image_3_thumb2.jpg" alt=""/>';
custom_options  +=											'</a>';
custom_options  +=										'</div>';
custom_options  +=										'<div id="co_bg_images">';
custom_options  +=										'</div>';
custom_options  +=									'</div>';
custom_options  +=								'</form>';
custom_options  +=							'</div>';
...
custom_options  +=								'<li class="menu-item current-menu-item current-menu-ancestor menu-item-has-children">';
custom_options  +=									'<a href="index.html">Home</a>';
custom_options  +=									'<ul class="sub-menu">';
custom_options  +=										'<li class="menu-item current-menu-ancestor menu-item-has-children">';
custom_options  +=											'<a href="#">Topic Style</a>';
custom_options  +=											'<ul class="sub-menu">';
custom_options  +=												'<li class="menu-item current-menu-item">';
custom_options  +=													'<a href="index.html">Beauty Center</a>';
custom_options  +=												'</li>';
custom_options  +=												'<li class="menu-item">';
custom_options  +=													'<a href="index2.html">Hair care</a>';
custom_options  +=												'</li>';
custom_options  +=												'<li class="menu-item">';
custom_options  +=													'<a href="index3.html">Spa Salon</a>';
custom_options  +=												'</li>';
custom_options  +=												'<li class="menu-item">';
custom_options  +=													'<a href="index4.html">Makeup</a>';
custom_options  +=												'</li>';
custom_options  +=												'<li class="menu-item">';
custom_options  +=													'<a href="index5.html">Landing</a>';
custom_options  +=												'</li>';
custom_options  +=											'</ul>';
custom_options  +=										'</li>';
custom_options  +=										'<li class="menu-item menu-item-has-children">';
custom_options  +=											'<a href="#">Layout Style</a>';
custom_options  +=											'<ul class="sub-menu">';
custom_options  +=												'<li class="menu-item">';
custom_options  +=													'<a href="index6.html">Portfolio</a>';
custom_options  +=												'</li>';
custom_options  +=												'<li class="menu-item">';
custom_options  +=													'<a href="index7.html">Blog Style</a>';
custom_options  +=												'</li>';
custom_options  +=												'<li class="menu-item">';
custom_options  +=													'<a href="index8.html">Side Menu</a>';
custom_options  +=												'</li>';
custom_options  +=												'<li class="menu-item">';
custom_options  +=													'<a href="index9.html">Video Header</a>';
custom_options  +=												'</li>';
custom_options  +=											'</ul>';
custom_options  +=										'</li>';
custom_options  +=									'</ul>';
custom_options  +=								'</li>';
custom_options  +=								'<li class="menu-item">';
custom_options  +=									'<a href="shop.html">Shop</a>';
custom_options  +=								'</li>';
custom_options  +=								'<li class="menu-item">';
custom_options  +=									'<a href="blog-classic-style-large.html">Blog</a>';
custom_options  +=								'</li>';
custom_options  +=								'<li class="menu-item">';
custom_options  +=									'<a href="portfolio-grid-3-columns.html">Portfolio</a>';
custom_options  +=								'</li>';
custom_options  +=								'<li class="menu-item menu-item-has-children">';
custom_options  +=									'<a href="#">Pages</a>';
custom_options  +=									'<ul class="sub-menu">';
custom_options  +=										'<li class="menu-item">';
custom_options  +=											'<a href="pages-reservation.html">Reservation</a>';
custom_options  +=										'</li>';
custom_options  +=										'<li class="menu-item">';
custom_options  +=											'<a href="pages-booking.html">Booking</a>';
custom_options  +=										'</li>';
custom_options  +=										'<li class="menu-item">';
custom_options  +=											'<a href="pages-events.html">Events</a>';
custom_options  +=										'</li>';
custom_options  +=										'<li class="menu-item">';
custom_options  +=											'<a href="pages-about-us.html">About Us</a>';
custom_options  +=										'</li>';
custom_options  +=										'<li class="menu-item">';
custom_options  +=											'<a href="pages-our-staff.html">Our Staff</a>';
custom_options  +=										'</li>';
custom_options  +=										'<li class="menu-item">';
custom_options  +=											'<a href="pages-price-table.html">Price Table</a>';
custom_options  +=										'</li>';
custom_options  +=										'<li class="menu-item">';
custom_options  +=											'<a href="pages-faq.html">FAQ’s</a>';
custom_options  +=										'</li>';
custom_options  +=										'<li class="menu-item">';
custom_options  +=											'<a href="pages-services.html">Services</a>';
custom_options  +=										'</li>';
custom_options  +=										'<li class="menu-item">';
custom_options  +=											'<a href="pages-contacts.html">Contacts</a>';
custom_options  +=										'</li>';
custom_options  +=										'<li class="menu-item">';
custom_options  +=											'<a href="pages-typography.html">Typography</a>';
custom_options  +=										'</li>';
custom_options  +=									'</ul>';
custom_options  +=								'</li>';
custom_options  +=								'<li class="menu-item ">';
custom_options  +=									'<a href="pages-shortcodes.html">Shortcodes</a>';
custom_options  +=								'</li>';
custom_options  +=							'</ul>';
custom_options  +=						'</nav>';
custom_options  +=						'<div class="searchBlock">';
custom_options  +=							'<form role="search" method="get" class="search-form" action="#">';
custom_options  +=								'<input type="text" class="searchField" placeholder="Search" value="" name="s" title="Search for:"/>';
...
jQuery(document).ready(function() {
	...
	jQuery('#co_theme_color').css('backgroundColor', '#fe90ad');
	jQuery('#co_theme_color_1').css('backgroundColor', '#84dce6');
	jQuery('#co_theme_color_2').css('backgroundColor', '#293364');
	jQuery('#co_theme_color_3').css('backgroundColor', '#fbc85b');
